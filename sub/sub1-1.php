...
<article class="concept sub-sec">
  <div id="block" class="bg-video" data-vide-bg="/video/clip1"></div>
  <div class="concept-wrap">
    ...
    <div class="sub-txt">
      <em>5,900원부터 <strong>합리적인 가격전략!</strong></em>
      <p>패밀리 레스토랑의 가격대가 높다는 편견을 지우는<br>카테고리별 최저가 메뉴 1개 이상을 유지합니다.</p>
    </div>
    <div class="sub-txt">
      <em>매장에 머무는<strong>모든 시간을 즐겁게!</strong></em>
      <p>고급 원두커피와 탄산음료를 셀프 서비스로 제공합니다.</p>
    </div>
    <div class="sub-txt">
      <em>단체부터 배달까지, <strong>전국 어디에서나</strong></em>
      <p>넓고 편안한 공간 연출로 단체 고객께 사랑받고,<br>배달 서비스로 홈 레스토랑 시대를 열어갑니다</p>
    </div>
  </div>
  <div id="block" class="bg-video" data-vide-bg="/video/clip2"></div>
</article>
